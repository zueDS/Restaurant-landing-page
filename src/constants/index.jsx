...
export const ABOUT = {
  ...
  content:
    "At Zue & Spice, we believe that great food goes beyond taste; it tells a story of dedication and creativity. From our chef's signature creations to our attentive service, every detail is curated to ensure your visit is nothing short of exceptional. Whether you're savoring our renowned Tikka Kebab or exploring our diverse menu inspired by global flavors, each dish is a celebration of flavor and innovation. Join us for a culinary journey where every bite leaves a lasting impression. Experience Zue & Spice—where every meal is a masterpiece.",
};

export const MISSION =
  "At our restaurant, Our mission is to create a dining experience that delights every guest, by serving high-quality, flavorful dishes made from fresh, locally sourced ingredients. We are committed to providing exceptional service, cultivating a warm and inviting atmosphere, and fostering a passion for food that brings people together.";
